...
$pdoStat = $objetPDO->prepare('SELECT*FROM typeimmobilier WHERE ID=:id');
...
<body>
   <header class="header">
      ...
      <div class="form-container">
         ...
         <form action="tiform-update.php" method="post">
            <h3>Modification</h3>
            <input type="hidden" name="ID" value="<?= $region['ID']; ?>">
            <input type="text" name="Libelle" value="<?= $region['Libelle']; ?>">
            <input type="text" name="PrixMin" value="<?= $region['PrixMin']; ?>">
